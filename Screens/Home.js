...
const Home = ({ route, navigation }) => {
  ...
  if (visible && !(start)) {
    ...
    return (
      ...
      <Card style={{ width:'auto',height:100,paddingTop:50,paddingBottom:70,paddingLeft:35,paddingRight:35, elevation: 15, backgroundColor:"#ffdab9", shaowRadius: 15,borderRadius:15 }}>
